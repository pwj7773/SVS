...
@Slf4j
@Controller
public class ComplainBoardController {
	//게시판 목록의 페이지당 글 수
	...
	private final String REDIRECT_LIST = "redirect:/complain/boardList";
	
	//글 목록보기
	@GetMapping("complain/boardList")
	...
	//글쓰기화면 보여주기
	@GetMapping("complain/boardWrite")
	...
	//글쓰기
	@PostMapping("complain/boardWrite")
	...
	//글 삭제
	@GetMapping("complain/boardDelete")
	...
	// 수정화면 보여주기
	@GetMapping("complain/boardUpdate")
	...
	// 글 수정
	@PostMapping("complain/boardUpdate")
